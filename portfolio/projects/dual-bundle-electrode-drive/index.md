...
images:
  ...
  - src: "images/render_6.png"
    caption: "Exploded three-quarter view (rear, left, top) render of the FreeLynx cover with LED and diffuser stack"
  - src: "images/render_7_annotated.png"
    caption: "Three-quarter view (rear, left, top) render of the drive cap and adjustable weight"
  - src: "images/render_8.png"
    caption: "Annotated three-quarter view (rear, left, top) render of the drive cap and adjustable weight"
